export const ContactSection = () =>{
    return (
        <section id="contact_section" class="contact_section container py-5">
        <h2 class="pb-4 mb-4 border-bottom text-center" data-aos="fade-up"  data-aos-duration="1500">Información de Contacto</h2>
        <div class="row justify-content-center">
            <div class="col-md-6 text-left mb-4">
                <ul class="list-unstyled">
                    <li class="mb-3" data-aos="fade-up"  data-aos-duration="1500">
        ...
        <div class="text-center mt-4">
            <a href="https://wa.me/584243239994?text=Hola%20Abraham,%20he%20visto%20tu%20sitio%20web%20y%20estoy%20interesado/a%20en%20tus%20servicios.%20Por%20favor,%20contáctame%20para%20más%20información." class="btn btn-success btn-lg" target="_blank">
